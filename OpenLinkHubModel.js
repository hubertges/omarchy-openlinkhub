...
var DEFAULT_FAN_PROFILES = [
  { id: "Quiet",       name: "Quiet",       labelPl: "Quiet",          icon: "󰠝" },
  { id: "Normal",      name: "Normal",      labelPl: "Normal",         icon: "󰠝" },
  { id: "Performance", name: "Performance", labelPl: "Performance",    icon: "󰠝" }
];

var DEFAULT_RGB_MODES = [
  { id: "wave",                name: "Wave",           labelPl: "Wave",             icon: "󰏌" },
  { id: "rainbow",             name: "Rainbow",        labelPl: "Rainbow",          icon: "󰏌" },
  { id: "spiralrainbow",       name: "Spiral Rainbow", labelPl: "Spiral Rainbow",   icon: "󰏌" },
  { id: "colorpulse",          name: "Color Pulse",    labelPl: "Color Pulse",      icon: "󰏌" },
  { id: "static",              name: "Static",         labelPl: "Static",           icon: "󰏌" },
  { id: "colorshift",          name: "Color Shift",    labelPl: "Color Shift",      icon: "󰏌" },
  { id: "circle",              name: "Circle",         labelPl: "Circle",           icon: "󰏌" },
  { id: "flickering",          name: "Flickering",     labelPl: "Flickering",       icon: "󰏌" },
  { id: "rotator",             name: "Rotator",        labelPl: "Rotator",          icon: "󰏌" },
  { id: "spinner",             name: "Spinner",        labelPl: "Spinner",          icon: "󰏌" },
  { id: "rain",                name: "Rain",           labelPl: "Rain",             icon: "󰏌" },
  { id: "visor",               name: "Visor",          labelPl: "Visor",            icon: "󰏌" },
  { id: "storm",               name: "Storm",          labelPl: "Storm",            icon: "󰏌" },
  { id: "off",                 name: "Off",            labelPl: "Off",              icon: "󰏌" }
];
